package tv.anilibria.feature.data.restapi.entity.app.release
...
data class ReleaseResponse(
    ...
    @Json(name = "day") val scheduleDay: String?,
    @Json(name = "description") val description: String?,
    @Json(name = "announce") val announce: String?,
    @Json(name = "favorite") val favoriteInfo: FavoriteInfoResponse?,
