...
class DownloadsDataSource(
    ...
    private val downloadsHolder: DownloadsStorage
) {
    ...
    private val completeReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            Log.e(
                TAG,
                "onReceive $downloadId, ${fetchDownloadRow(downloadId)}, ${findCached(downloadId)}"
            )
    ...
    private var pendingTimerJob: Job? = null
