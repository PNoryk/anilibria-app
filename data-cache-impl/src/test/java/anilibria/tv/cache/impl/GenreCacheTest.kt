...
class GenreCacheTest {
    ...
    private val storageDataSource = mockk<GenreStorageDataSource>()
    private val memoryDataSource = mockk<GenreMemoryDataSource>()
    private val cache = GenreCacheImpl(storageDataSource, memoryDataSource)
